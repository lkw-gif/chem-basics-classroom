...
assert.deepEqual(count(molecule('O3')),{O:3});assert.equal(molecule('O3').bonds.length,2);
assert.deepEqual(count(makeScene('sample:pure-He')),{He:8});assert.equal(makeScene('sample:pure-He').bonds.length,0);
assert.deepEqual(count(makeScene('sample:pure-N2')),{N:16});assert.deepEqual(count(makeScene('sample:pure-O3')),{O:24});assert.deepEqual(count(makeScene('sample:pure-CO2')),{O:16,C:8});
